...
const AWARDS_DB = [
  ...
  { id: 'pizza_1m', title: 'Pizza Magnate', isSecret: false, isUnlocked: false, desc: 'One million souls fed. Your influence spreads like sauce on dough. The Obsidian Syndicate watches with interest.', icon: <Building2 size={40} className="text-blue-500" /> },
  { id: 'pizza_100k', title: 'Neighborhood Favorite', isSecret: false, isUnlocked: false, desc: 'One hundred thousand pizzas. You are no longer a chef—you are an institution. A pillar of the community.', icon: <Truck size={40} className="text-green-500" /> },
  { id: 'pizza_10m', title: 'National Chain', isSecret: false, isUnlocked: false, desc: 'Ten million pizzas across the nation. Your brand is everywhere. The Syndicate takes note of your expansion.', icon: <Globe2 size={40} className="text-blue-500" /> },
  { id: 'pizza_1b', title: 'Global Dominance', isSecret: false, isUnlocked: false, desc: 'One billion pizzas sold worldwide. Nations rise and fall on your supply chain. You are no longer in the pizza business—you ARE the pizza business.', icon: <Globe2 size={40} className="text-purple-500" /> },
  { id: 'pizza_1t', title: 'Universal Crust', isSecret: false, isUnlocked: false, desc: 'One trillion pizzas baked across all realities. The crust transcends space and time.', icon: <Rocket size={40} className="text-cyan-500" /> },
  ...
  { id: 'clicker_1k', title: 'Carpal Tunnel', isSecret: false, isUnlocked: false, desc: 'Your fingers have become instruments of profit. 1,000 clicks. Each one a prayer to the god of commerce.', icon: <Zap size={40} className="text-yellow-400" /> },
  { id: 'click_10k', title: 'Clicking Machine', isSecret: false, isUnlocked: false, desc: 'Ten thousand clicks. You and the pizza are one. The boundary between action and intention dissolves.', icon: <MousePointerClick size={40} className="text-blue-500" /> },
  { id: 'click_100k', title: 'The Auto-Clicker', isSecret: false, isUnlocked: false, desc: 'One hundred thousand clicks. Are you clicking, or is the universe clicking through you? The Syndicate knows the answer.', icon: <MousePointerClick size={40} className="text-purple-500" /> },

  // 4. THE CORPORATE LADDER & LIFESTYLE
  { id: 'sellout', title: 'Corporate Sellout', isSecret: false, isUnlocked: false, desc: 'You sold your soul for a Franchise License. But was it really yours to begin with? The cycle begins anew.', icon: <Briefcase size={40} className="text-purple-500" /> },
  { id: 'combo_max', title: 'On Fire!', isSecret: false, isUnlocked: false, desc: 'Time bends to your will. 100x combo achieved. You have touched the edge of what the Syndicate calls "The Flow State."', icon: <Zap size={40} className="text-orange-500" /> },
  { id: 'perfect_pull', title: 'Chef\'s Kiss', isSecret: false, isUnlocked: false, desc: 'Perfection achieved. The oven reveals its secrets only to those who listen. This is the first step toward mastery.', icon: <Flame size={40} className="text-red-500" /> },
  { id: 'combo_10', title: 'Heating Up', isSecret: false, isUnlocked: false, desc: 'Ten-click combo. The rhythm accelerates. You feel the heat building, the momentum gathering.', icon: <Zap size={40} className="text-yellow-400" /> },
  { id: 'combo_50', title: 'Blazing Fast', isSecret: false, isUnlocked: false, desc: 'Fifty-click combo. Your hands are a blur. Time itself seems to slow around you. The Syndicate calls this "temporal dilation."', icon: <Zap size={40} className="text-orange-500" /> },
  { id: 'perfect_10', title: 'Oven Master', isSecret: false, isUnlocked: false, desc: 'Ten perfect pizzas. You have learned to read the oven\'s language. Heat, time, and intuition become one.', icon: <Flame size={40} className="text-orange-500" /> },
  { id: 'perfect_50', title: 'Flawless Execution', isSecret: false, isUnlocked: false, desc: 'Fifty perfect pizzas. Perfection is no longer luck—it is your default state. The oven obeys your will.', icon: <Flame size={40} className="text-red-500" /> },
  { id: 'delivery_first', title: 'Road Trip', isSecret: false, isUnlocked: false, desc: 'The first delivery through the time-warped routes. You have glimpsed the temporal network the Syndicate controls.', icon: <Truck size={40} className="text-green-500" /> },
  { id: 'delivery_10', title: 'Logistics Master', isSecret: false, isUnlocked: false, desc: 'Ten journeys through folded space. You begin to understand: the map is not the territory. The territory is whatever you make it.', icon: <Truck size={40} className="text-blue-500" /> },
  { id: 'delivery_50', title: 'Logistics Expert', isSecret: false, isUnlocked: false, desc: 'Fifty deliveries through the warped routes. You navigate the impossible with ease. The Syndicate\'s temporal network is yours to command.', icon: <Rocket size={40} className="text-purple-500" /> },
  { id: 'delivery_250', title: 'Worldwide Shipping', isSecret: false, isUnlocked: false, desc: 'Two hundred fifty deliveries across space and time. You have mastered the art of being everywhere at once.', icon: <Rocket size={40} className="text-cyan-500" /> },
  { id: 'rep_500', title: 'Rising Star', isSecret: false, isUnlocked: false, desc: 'Five hundred reputation points. People speak your name with reverence. Your star is ascending.', icon: <Star size={40} className="text-yellow-400" /> },
  { id: 'rep_10k', title: 'Household Name', isSecret: false, isUnlocked: false, desc: 'Ten thousand reputation. You are legend. Children dream of your pizzas. The Syndicate sees potential.', icon: <Star size={40} className="text-purple-500" /> },
  ...
  { id: 'franchise_5', title: 'Corporate Board', isSecret: false, isUnlocked: false, desc: 'Five Franchise Licenses. You sit at the table now. The Corporate veil begins to lift, revealing something darker beneath.', icon: <Briefcase size={40} className="text-purple-500" /> },
  { id: 'franchise_10', title: 'Pizza Conglomerate', isSecret: false, isUnlocked: false, desc: 'Ten Franchise Licenses. Your empire spans realities. Each reset makes you stronger. The Syndicate smiles.', icon: <Building2 size={40} className="text-blue-500" /> },
  { id: 'franchise_25', title: 'Global Syndicate', isSecret: false, isUnlocked: false, desc: 'Twenty-five Licenses. You have become what you once feared. The Obsidian Syndicate welcomes you as one of their own.', icon: <Crown size={40} className="text-yellow-400" /> },
  { id: 'franchise_50', title: 'Crust Fund', isSecret: false, isUnlocked: false, desc: 'Fifty Licenses. Your wealth compounds across timelines. The Syndicate reveals the first truth: time is a circle.', icon: <Crown size={40} className="text-purple-600" /> },
  { id: 'franchise_100', title: 'Galactic Dominance', isSecret: false, isUnlocked: false, desc: 'One hundred Licenses. You control galaxies of franchises. The Syndicate whispers: "You are ready for the Golden Slices."', icon: <Crown size={40} className="text-cyan-500" /> },
  { id: 'franchise_150', title: 'Universal Control', isSecret: false, isUnlocked: false, desc: 'One hundred fifty Licenses. Universes bend to your franchise model. The Syndicate reveals the second truth: reality is negotiable.', icon: <Crown size={40} className="text-indigo-500" /> },
  { id: 'franchise_200', title: 'Dimensional Overlord', isSecret: false, isUnlocked: false, desc: 'Two hundred Licenses. You operate across dimensions. The Syndicate reveals the third truth: you were always one of us.', icon: <Crown size={40} className="text-purple-700" /> },

  // 7. LIFETIME EARNINGS
  { id: 'life_1q', title: 'Quadrillionaire', isSecret: false, isUnlocked: false, desc: 'One quadrillion dollars earned. Numbers lose meaning at this scale. The Syndicate nods: "You understand now."', icon: <Star size={40} className="text-yellow-500" /> },

  // 8. PIZZA VOLUME
  { id: 'pizza_10b', title: 'Factory Planet', isSecret: false, isUnlocked: false, desc: 'Ten billion pizzas. Entire planets are dedicated to your production. The Syndicate reveals: this is only one timeline.', icon: <Globe2 size={40} className="text-cyan-400" /> },

  // 9. LATE UPGRADES
  { id: 'upgrade_wagyu', title: 'Premium Grade', isSecret: false, isUnlocked: false, desc: 'Wagyu beef on pizza. Decadence incarnate. The Syndicate approves of your refined taste for the excessive.', icon: <Star size={40} className="text-red-500" /> },
  { id: 'upgrade_antimatter', title: 'Beyond Physics', isSecret: false, isUnlocked: false, desc: 'Antimatter crust. You have broken the laws of physics for profit. The Syndicate reveals: reality is just another ingredient.', icon: <Zap size={40} className="text-purple-400" /> },
  { id: 'upgrade_neural', title: 'Mind Over Pizza', isSecret: false, isUnlocked: false, desc: 'Neural interface clicking. Your thoughts become pizzas. The boundary between mind and matter dissolves. The Syndicate smiles.', icon: <Crown size={40} className="text-cyan-400" /> },
  { id: 'upgrade_michelin', title: 'Fine Dining', isSecret: false, isUnlocked: false, desc: 'A Michelin Star. The culinary elite recognize your mastery. But the Syndicate knows: stars are just burning gas.', icon: <Star size={40} className="text-green-500" /> },

  // 10. MARKET ACHIEVEMENTS
  { id: 'market_first_trade', title: 'Wall Street Rookie', isSecret: false, isUnlocked: false, desc: 'Your first market trade. You have entered the game within the game. The Syndicate controls the market—but you can learn to dance with it.', icon: <TrendingDown size={40} className="text-red-400" /> },
  { id: 'market_100_trades', title: 'Day Trader', isSecret: false, isUnlocked: false, desc: 'One hundred trades. You read the patterns now. Buy low, sell high. The Syndicate watches your growing understanding.', icon: <TrendingDown size={40} className="text-orange-500" /> },
  { id: 'market_1k_trades', title: 'Market Veteran', isSecret: false, isUnlocked: false, desc: 'One thousand trades. The market is your playground. You manipulate flour prices like a puppet master. The Syndicate nods in approval.', icon: <TrendingDown size={40} className="text-green-400" /> },
  { id: 'market_profit_1m', title: 'Portfolio Manager', isSecret: false, isUnlocked: false, desc: 'One million in market profits. You have learned to extract value from chaos itself. The Syndicate reveals: chaos is just order you don\'t understand yet.', icon: <CircleDollarSign size={40} className="text-emerald-400" /> },

  // 11. ADDITIONAL REGULAR ACHIEVEMENTS
  { id: 'billionaire', title: 'Pizza Billionaire', isSecret: false, isUnlocked: false, desc: 'One billion dollars. Money is just numbers now. The Syndicate whispers: "This is only the beginning."', icon: <Crown size={40} className="text-yellow-600" /> },
  { id: 'life_10k', title: 'Humble Beginnings', isSecret: false, isUnlocked: false, desc: 'Your first $10,000 earned. Every fortune starts somewhere. The Syndicate remembers its own humble origins.', icon: <CircleDollarSign size={40} className="text-green-500" /> },
  { id: 'life_10m', title: 'Crust Fund', isSecret: false, isUnlocked: false, desc: 'Ten million earned across all timelines. Your legacy grows. The dough rises, as do you.', icon: <CircleDollarSign size={40} className="text-blue-400" /> }
];
...
export default function ExecutiveStickerbook({ unlockedIds = [] }) {
  ...
  const getVisibleAchievements = () => {
    ...
    // Finally, add all secret achievements at the bottom
    AWARDS_DB.filter(a => a.isSecret).forEach(a => visible.push(a));
                  ...
                  {isUnlocked ? (
                    <div className="w-3/4 h-3/4 rounded-full bg-gradient-to-br from-yellow-200 via-amber-400 to-amber-600 p-[2px] shadow-lg">
                      <div className="w-full h-full bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-full flex items-center justify-center border border-amber-600/30">
                        <div className="scale-75 sm:scale-90 opacity-90 text-amber-200">{award.icon}</div>
                      </div>
