...
const UPGRADES = [
  ...
  { id: 'soda', name: 'Soda Combos', type: 'quality', baseCost: 350, multi: 1.72, baseValue: 0.075, reqStars: 0, icon: <Coffee className="text-amber-500" /> },
  { id: 'garlicCrust', name: 'Garlic Crust', type: 'quality', baseCost: 800, multi: 1.72, baseValue: 0.225, reqStars: 1, icon: <Award className="text-yellow-400" /> },
  { id: 'premiumMeat', name: 'Premium Meats', type: 'quality', baseCost: 5000, multi: 1.72, baseValue: 0.60, reqStars: 2, icon: <Pizza className="text-orange-500" /> },
