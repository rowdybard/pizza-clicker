                ...
                <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-4 mt-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-sm font-black text-zinc-300 uppercase tracking-wider">Join the Community</h3>
                        <p className="text-xs text-zinc-500">Share strategies, get updates & chat with players</p>
                      </div>
                    </div>
                    <a 
                      ...
                      className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 px-6 rounded-lg btn-tactile border-b-[4px] border-indigo-900 active:border-b-0 active:translate-y-[4px] transition-all duration-100 flex items-center gap-2"
                    >
